...
func (e *EditorService) CreateDockerCompose(gitopsSecretToken, bitswanEditorImage, domain string) (string, error) {
...
func (e *EditorService) Enable(gitopsSecretToken, bitswanEditorImage, domain string) error {
