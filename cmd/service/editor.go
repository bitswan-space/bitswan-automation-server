...
func newEditorEnableCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return enableEditorService(editorImage)
		},
	}
...
func enableEditorService(editorImage string) error {
	...
	// Enable the service
	if err := editorService.Enable(gitopsSecretToken, bitswanEditorImage, domain); err != nil {
		return err
	}
